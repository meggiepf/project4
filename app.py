...
@app.route('/WebVisualizations/index.html')
def form():
    return render_template('WebVisualizations/index.html')
...
def predict():
    ...
    if output == 0:
        return render_template('WebVisualizations/index.html', 
                               result = 'Lending Club grade would be A')
    elif output == 1:
        return render_template('WebVisualizations/index.html', 
                               result = 'Lending Club grade would be B')
    elif output == 2:
        return render_template('WebVisualizations/index.html', 
                               result = 'Lending Club grade would be C')
    elif output == 3:
        return render_template('WebVisualizations/index.html', 
                               result = 'Lending Club grade would be D')
    elif output == 4:
        return render_template('WebVisualizations/index.html', 
                               result = 'Lending Club grade would be E')
    elif output == 5:
        return render_template('WebVisualizations/index.html', 
                               result = 'Lending Club grade would be F')
    elif output == 6:
        return render_template('WebVisualizations/index.html', 
                               result = 'Lending Club grade would be G')
